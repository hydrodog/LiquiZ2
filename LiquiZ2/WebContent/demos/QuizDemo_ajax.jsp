...
page.matrix(1, 1, 8);
  ...
  //  page.grid([[1, 0, 2],[1, 1, -2],[2, 1, 0]]);
    page.span("*");
  //  page.grid([[1, 1, -1],[-2, 1, 0],[1, 1, 3]]);
    page.span("=");
    page.matrix(2, 3, 3);
    ...
    page.txt("What is the square root of 2 (four digits is fine)?");
    page.numeric(15);

    page.addQuestion(16, "Geography");
    page.lin("Click on Texas");
    page.clickableMap(16,"usmap.png");
    quiz.end();
