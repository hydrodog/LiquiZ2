...
<div>
<input type="text" name="QuizName" value="593_Quiz1_Sorting">
...
$("#NewQz").click(function(){
	$('#tblQuiz').append("<tr class='Qz'><td style='width: 2%'><button type='button' class='EditQz'>Edit</button></td><td style='width: 2%'><input type='checkbox' class = 'QzChk' id='Qz4'></td><td><input type='text' class='newQzName'></td></tr>");
})
...
$("#NewQs").click(function(){
	$('#tblQues').append("<tr class='Qs'><td style='width: 2%'><button type='button' class='EditQs'>Edit</button></td><td style='width: 2%'><input type='checkbox' class = 'QsChk' id='Qs4'></td><td><input type='text' class='newQsName'></td></tr>");
});
</script>
